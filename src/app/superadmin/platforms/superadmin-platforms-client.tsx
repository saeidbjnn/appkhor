...
type Props = {
  email: string;
  platforms: SuperadminPlatformRow[];
};
...
export default function SuperadminPlatformsClient({
  email,
  platforms,
}: Props) {
  ...
  const [editing, setEditing] =
    useState<SuperadminPlatformRow | null>(null);
  ...
  function openEdit(platform: SuperadminPlatformRow) {
    setEditing(platform);
    setSaveError("");
  ...
  async function savePlatform(values: PlatformFormValues) {
    setSaving(true);
    setSaveError("");
    ...
    try {
      const response = await fetch(
        editing
          ? `/api/superadmin/platforms/${editing.id}`
          : "/api/superadmin/platforms",
        {
  ...
  const columns: TableColumnsType<SuperadminPlatformRow> = [
    {
      title: "\u067e\u0644\u062a\u0641\u0631\u0645",
      key: "platform",
      render: (_, record) => (
              ...
              <div className="mx-auto max-w-7xl">
                <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <Text type="secondary">
                      {"\u0633\u0627\u062e\u062a\u060c \u0648\u06cc\u0631\u0627\u06cc\u0634 \u0648 \u06a9\u0646\u062a\u0631\u0644 \u0646\u0645\u0627\u06cc\u0634 \u067e\u0644\u062a\u0641\u0631\u0645\u200c\u0647\u0627"}
                    </Text>
                  </div>
