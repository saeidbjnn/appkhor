/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: d2ca85eb112c4b6c2b1d7edb8fee0d79)
// Runtime types generated with workerd@1.20260801.1 2026-08-07 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	appkhor_db: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* appkhor */;
}
